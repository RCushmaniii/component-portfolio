...
export default function Home() {
  ...
  const categories = [
    ...
    { id: 'navigation', name: 'Navigation', count: 22, icon: MousePointerClick },
    { id: 'data', name: 'Data Display', count: 19, icon: BarChart3 },
  ...
  const featuredComponents = [
    {
      ...
      tags: ['React', 'SVG Filters', 'Physics'],
      complexity: 'Advanced',
      popularity: 98,
    ...
    },
    {
      ...
      category: 'animation',
      description: 'Hero section with overlapping images, wave effects, and AI-themed content',
      tags: ['React', 'CSS Masks', 'SVG'],
    ...
    },
    {
      ...
      complexity: 'Intermediate',
      popularity: 87,
      demoPath: '/demo/particle-feedback'
    },
    {
      id: 6,
      ...
      complexity: 'Intermediate',
      popularity: 95,
      demoPath: '/demo/magnetic-buttons'
    }
  ]
  ...
  return (
    <div className={`min-h-screen overflow-x-hidden ${
      ...
      {/* Hero Section */}
      <section className="relative flex items-center justify-center pt-12 pb-20 md:pt-16 md:pb-24 lg:min-h-[85vh]">
        ...
        } bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,black,transparent)]`} />
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-orange-500 rounded-xl font-semibold text-lg text-white hover:shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300 flex items-center justify-center">
                  Explore Components
                ...
                <button className={`px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 ${
                  theme === 'dark'
                    ...
                    : 'bg-slate-900/5 backdrop-blur border border-slate-200 hover:bg-slate-900/10'
                }`}>
                  View on GitHub
                </button>
              </div>
              ...
              <div className={`grid grid-cols-3 gap-8 mt-12 pt-12 border-t ${
                ...
                <div>
                  ...
                  <div className={`text-sm mt-1 ${theme === 'dark' ? 'text-gray-500' : 'text-slate-500'}`}>GitHub Stars</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">98%</div>
                  <div className={`text-sm mt-1 ${theme === 'dark' ? 'text-gray-500' : 'text-slate-500'}`}>Accessibility Score</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600">60fps</div>
                  <div className={`text-sm mt-1 ${theme === 'dark' ? 'text-gray-500' : 'text-slate-500'}`}>Performance</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative w-full aspect-square max-w-md mx-auto">
                ...
                <div className="absolute inset-0">
                  {/* Card 1 */}
                  <div className={`absolute top-0 right-0 w-48 h-32 rounded-2xl p-4 animate-float-slow ${
                    theme === 'dark'
                      ? 'bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur border border-blue-500/20'
                      : 'bg-gradient-to-br from-blue-100/80 to-blue-200/80 backdrop-blur border border-blue-300/40'
                  }`}>
                    <Code2 className="w-6 h-6 text-blue-400 mb-2" />
                    <div className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-slate-700'}`}>Clean Code</div>
                    <div className={`text-xs mt-1 ${theme === 'dark' ? 'text-gray-500' : 'text-slate-500'}`}>TypeScript Ready</div>
                  </div>
                  
                  {/* Card 2 */}
                  <div className={`absolute bottom-20 left-0 w-48 h-32 rounded-2xl p-4 animate-float-medium ${
                    theme === 'dark'
                      ? 'bg-gradient-to-br from-orange-600/20 to-orange-800/20 backdrop-blur border border-orange-500/20'
                      : 'bg-gradient-to-br from-orange-100/80 to-orange-200/80 backdrop-blur border border-orange-300/40'
                  }`}>
                    <Palette className="w-6 h-6 text-orange-400 mb-2" />
                    <div className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-slate-700'}`}>Customizable</div>
                    <div className={`text-xs mt-1 ${theme === 'dark' ? 'text-gray-500' : 'text-slate-500'}`}>Tailwind + CSS-in-JS</div>
                  </div>
                  
                  {/* Card 3 */}
                  <div className={`absolute top-1/3 right-1/4 w-48 h-32 rounded-2xl p-4 animate-float-fast ${
                    theme === 'dark'
                      ? 'bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur border border-purple-500/20'
                      : 'bg-gradient-to-br from-purple-100/80 to-purple-200/80 backdrop-blur border border-purple-300/40'
                  }`}>
                    <Zap className="w-6 h-6 text-purple-400 mb-2" />
                    <div className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-slate-700'}`}>Lightning Fast</div>
                    <div className={`text-xs mt-1 ${theme === 'dark' ? 'text-gray-500' : 'text-slate-500'}`}>Optimized Bundle</div>
                  </div>
            ...
            {categories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`text-xs ${theme === 'dark' ? 'text-gray-500' : 'text-slate-500'}`}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
            <div>
              ...
              <p className={`text-xl ${theme === 'dark' ? 'text-gray-400' : 'text-slate-600'}`}>
                Hand-picked excellence for modern applications
              </p>
            </div>
            ...
            <div className="relative w-full md:w-80">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3 rounded-xl focus:outline-none transition-all ${
                  theme === 'dark'
                    ? 'bg-white/5 border border-white/10 focus:border-blue-500/50 focus:bg-white/10 text-white placeholder-gray-500'
                    : 'bg-slate-50 border border-slate-200 focus:border-blue-500 focus:bg-white text-slate-900 placeholder-slate-400'
                }`}
              />
            </div>
          </div>
            ...
            {filteredComponents.map((component) => (
              ...
              >
                <div className={`relative p-6 rounded-2xl border transition-all duration-300 h-full ${
                  theme === 'dark'
                    ? 'bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur border-white/10 hover:border-blue-500/30'
                    : 'bg-gradient-to-br from-slate-50 to-white backdrop-blur border-slate-200 hover:border-blue-400'
                }`}>
          ...
          <div className="text-center mt-12">
            <button className={`px-8 py-3 rounded-xl transition-all ${
              theme === 'dark'
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative group">
              ...
              <div className={`relative p-8 rounded-2xl border transition-all h-full ${
                theme === 'dark'
                  ? 'bg-white/5 backdrop-blur border-white/10 hover:border-blue-500/30'
                  : 'bg-slate-50 backdrop-blur border-slate-200 hover:border-blue-400'
              }`}>
            ...
            <div className="relative group">
              ...
              <div className={`relative p-8 rounded-2xl border transition-all h-full ${
                theme === 'dark'
                  ? 'bg-white/5 backdrop-blur border-white/10 hover:border-orange-500/30'
                  : 'bg-slate-50 backdrop-blur border-slate-200 hover:border-orange-400'
              }`}>
            ...
            <div className="relative group">
              ...
              <div className={`relative p-8 rounded-2xl border transition-all h-full ${
                theme === 'dark'
                  ? 'bg-white/5 backdrop-blur border-white/10 hover:border-purple-500/30'
                  : 'bg-slate-50 backdrop-blur border-slate-200 hover:border-purple-400'
              }`}>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="relative">
            ...
            <div className={`relative rounded-3xl p-12 md:p-16 ${
              theme === 'dark'
                ? 'bg-gradient-to-br from-white/10 to-white/5 backdrop-blur border border-white/10'
                : 'bg-gradient-to-br from-slate-50 to-white backdrop-blur border border-slate-200'
            }`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-orange-500 rounded-xl font-semibold text-lg text-white hover:shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 transition-all">
                  Get Started Free
                </button>
                <button className={`px-8 py-4 rounded-xl font-semibold text-lg transition-all ${
                  theme === 'dark'
                    ? 'bg-white/5 backdrop-blur border border-white/10 hover:bg-white/10'
                    : 'bg-slate-50 backdrop-blur border border-slate-200 hover:bg-slate-100'
                }`}>
