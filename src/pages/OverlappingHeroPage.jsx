...
import OverlappingHeroCore from '../demos/hero-sections/OverlappingHero/OverlappingHeroCore'
import ControlPanel from '../demos/hero-sections/OverlappingHero/ControlPanel'

export default function OverlappingHeroPage() {
    ...
    <div className={`min-h-screen ${
      ...
      <div className="relative h-[calc(100vh-140px)] md:h-[calc(100vh-105px)]">
        ...
        <div className="w-full h-full flex items-center justify-center px-0 md:p-4 lg:p-8">
          {componentId === 'overlapping-hero' && (
            <OverlappingHeroCore config={config} theme={theme} {...config} />
          )}
        </div>
